                ...
                <div className="relative z-10">
                    <div className="flex items-center space-x-2 mb-2">
                        <div className="bg-white p-1.5 rounded-full shadow-sm">
                             <Headphone size="16" color='currentColor' className="text-emerald-900" variant="Bold"/>
                        </div>
                        <span className="font-semibold text-sm text-gray-900">Need support?</span>
                    </div>
                    <p className="text-xs text-gray-500 mb-3">Contact with one of our experts to get support.</p>
                </div>
            </div>
            ...
            <div className="flex items-center justify-between border-t border-gray-100 pt-4">
                <div className="flex items-center space-x-3">
                    ...
                    <div className="flex flex-col">
                        <span className="text-sm font-bold text-gray-900">Olaoluwa</span>
        ...
        <header className="bg-white h-16 lg:h-20 border-b border-gray-100 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-30">
            ...
            <div className="flex items-center space-x-3 lg:space-x-4">
               ...
               <div className="flex items-center space-x-3 lg:hidden">
                    ...
                    <div>
                        <h1 className="text-sm font-bold text-gray-900">Hi, Olaoluwa 👋</h1>
            ...
            <div className="flex items-center space-x-3 lg:space-x-4">
                ...
                <button className="hidden lg:flex bg-emerald-900 hover:bg-emerald-800 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-colors items-center">
                   New Escrow
                    <ArrowDown2 size="16" color='currentColor' className="ml-2 rotate-[-90deg] text-white "/>
                </button>
            </div>
        </header>
